...
while ($res = mysqli_fetch_array($resultado)) {
    ...
    if (!$res['Usuario_bloqueado']) {
        ...
        $punto1 = [$_REQUEST['latitud'], $_REQUEST['longitud']];
        $punto2 = [36.6870137, -6.11109117];

        //if( distance($punto1[0], $punto1[1], $punto2[0], $punto2[1]) < 51){
        ...
        if (password_verify($contrasenna, $res['Usuario_clave'])) {
            ...
            while ($bloq = mysqli_fetch_array($bloqueo)) {
                ...
                if ($intentos === 3) {
                                                                                ...
                                                                                <table
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class='es-p10t es-p20r es-p20l'
                                                                                            bgcolor='transparent' align='left'>
                                                                                            <p style='color: #583046'>Parece que tu cuenta ha sido bloqueada.</p>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td class='es-p5t es-p20r es-p20l' bgcolor='transparent'
                                                                                            align='left'>
                                                                                            <p style='color: #583046'>Si has sido tu desbloqueala 
                                                                                            ahora mismo haciendo click en el botón. 
                                                                                            Si no has sido tú más vale que cambies la contraseña.</p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                            </td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class='es-p10' align='center'><span
                                                                                                ...
                                                                                                style='border-radius: 20px;border-color: #2cb543;background: #583046'><a
                                                                                                    ...
                                                                                                    target='_blank'
                                                                                                    style='background: #583046;border-color: #583046;border-radius: 20px;border-width: 20px 60px'>
                                                                                                    Reactivar cuenta</a></span></td>
                                                                                    </tr>
                                                                                </table>
                                                                            </td>
                                                                        </tr>
                    ...
                    $mail->setFrom('info@aitor.works', 'Reactivacion aitor.works');
                    $mail->addReplyTo('info@aitor.works', 'aitor.works');
                    $mail->addAddress($email, $nombre);
                    $mail->Subject = 'Reactivacion cuenta';
                    $mail->IsHTML(true);
                    $mail->Charset = 'UTF-8';
        ...
        //$fallo = "true";
        //header("location:../HTML/inicioSesion.php?ubicacion=$fallo");
