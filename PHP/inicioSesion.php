...
while( $res = mysqli_fetch_array($resultado) ){
    ...
    if( !$res['Usuario_bloqueado'] ){
        ...
        if(password_verify($contrasenna, $res['Usuario_clave'])){
                ...
                mysqli_query($conexion, "UPDATE usuarios SET Usuario_numero_intentos = '$intentos' WHERE Usuario_email = '$email'") or
                            die("Problemas al desbloquear:" . mysqli_error($conexion));
            ...
            $bloqueo = mysqli_query($conexion, $usuario)
                    or die( "Problemas al buscar usuario: ".mysqli_error($conexion) );

            while( $bloq = mysqli_fetch_array($bloqueo) ){

                $intentos = $bloq['Usuario_numero_intentos'] + 1;

                mysqli_query($conexion, "UPDATE usuarios SET Usuario_numero_intentos = '$intentos' WHERE Usuario_id = '$bloq[Usuario_id]'") or
                            die("Problemas al bloquear:" . mysqli_error($conexion));

                if( $intentos === 3 ){
                    
                    $numConfirmacion = rand(1000, 9999);
                    
                    mysqli_query($conexion, "UPDATE usuarios SET Usuario_bloqueado = '1', Usuario_token_aleatorio = '$numConfirmacion' WHERE Usuario_id = '$bloq[Usuario_id]'") or
                            die("Problemas al bloquear:" . mysqli_error($conexion));
                    ...
                    $codigo = "
                        ...
                        <html xmlns='http://www.w3.org/1999/xhtml' xmlns:o='urn:schemas-microsoft-com:office:office' style='width:100%;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0'>
                            ...
                            <title>Reactivación de cuenta</title><!--[if (mso 16)]>
                            <style type='text/css'>
                            ...
                            <div class='es-wrapper-color' style='background-color:#F4F4F4'><!--[if gte mso 9]>
                                ...
                                <tr style='border-collapse:collapse'>
                                <td style='padding:0;Margin:0;background-color:#c850c0' bgcolor='#C850C0' align='center'>
                                ...
                                <tr style='border-collapse:collapse'>
                                <td align='center' style='Margin:0;padding-bottom:5px;padding-left:30px;padding-right:30px;padding-top:35px'><h1 style='Margin:0;line-height:58px;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;font-size:48px;font-style:normal;font-weight:normal;color:#111111'>Hola de nuevo!</h1></td>
                                </tr>
                                <tr style='border-collapse:collapse'>
                                ...
                                <tr style='border-collapse:collapse'>
                                <td class='es-m-txt-l' bgcolor='#ffffff' align='left' style='Margin:0;padding-top:20px;padding-bottom:20px;padding-left:30px;padding-right:30px'><p style='Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;font-size:18px'>Parece que alguien ha intentado acceder a tu cuenta, por eso hemos decidido bloquearla. Si no has sido tu cambia la contraseña urgentemente, si has sido tu cambiala igualmente, porque se ve que no te acuerdas.</p></td>
                                </tr>
                                <tr style='border-collapse:collapse'>
                                <td align='center' style='Margin:0;padding-left:10px;padding-right:10px;padding-top:35px;padding-bottom:35px'><span class='es-button-border' style='border-style:solid;border-color:#FFA73B;background:#c850c0;border-width:0px;display:inline-block;border-radius:2px;width:auto'; text-decoration:none;><a href='https://aitormenachovega.000webhostapp.com/PHP/confirmacion.php?usuario=$email&clave=$numConfirmacion' class='es-button es-button-1' target='_blank' style='mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:20px;border-style:solid;border-color:#c850c0;border-width:15px 30px;display:inline-block;background:#c850c0;border-radius:2px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center'>Reactivar</a></span></td>
                                </tr>
                                <tr style='border-collapse:collapse'>
                                <td class='es-m-txt-l' align='left' style='padding:0;Margin:0;padding-top:20px;padding-left:30px;padding-right:30px'><p style='Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;font-size:18px'>Por favor, no respondas a este correo porque no será contestado.</p></td>
                                </tr>
                                <tr style='border-collapse:collapse'>
                                <td class='es-m-txt-l' align='left' style='Margin:0;padding-top:20px;padding-left:30px;padding-right:30px;padding-bottom:40px'><p style='Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;font-size:18px'>Muchas gracias,</p><p style='Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;font-size:18px'>Aitor Menacho Vega</p></td>
                                </tr>
                                </table></td>
                                </tr>
                                </table></td>
